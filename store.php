...
<!--/style-->
   ...
   <!-- Marketing messaging and featurettes
    ...
    <div class="container marketing">
		...
		<center>
            <div class="col-md-6">
				<a href="produk.php?p=band">
                <img class="featurette-image img-responsive" data-src="holder.js/500x500/auto" src="img/band.png" alt="Generic placeholder image">
				</a>
            </div>
            <div class="col-md-6">
				<a href="produk.php?p=properti">
                <img class="featurette-image img-responsive" data-src="holder.js/500x500/auto" src="img/properti.png" alt="Generic placeholder image">
				</a>
            </div>
        </div>
...
<!-- Bootstrap core JavaScript
    ...
    <script src="js/slide/jquery-1.9.1.min.js"></script>
    <script src="js/slide/bootstrap.min.js"></script>
    <script src="js/slide/docs.min.js"></script>
    <!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
    <script src="js/slide/ie10-viewport-bug-workaround.js"></script>
