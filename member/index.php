...
<script>$(document).ready(function(c) {
	$('.alert-close1').on('click', function(c){
		$('.alert-box.success').fadeOut('slow', function(c){
	...
	<div class="total-content">
		<div class="col-md-3 side-bar">
			...
			<div class="navigation">
				...
				echo"
				<ul>
					<li><a href='?username=$_SESSION[username]&hal=7'><i class='user'></i></a></li>
					<li><a href='?username=$_SESSION[username]&hal=7'>View Profile </a></li>
				</ul>";
				?>
				<ul>
					<li><a href="?hal=4"><i class="fat"></i></a></li>
					<li><a href="?hal=4">Tambah Band</a></li>
				</ul>
				<ul>
					<li><a href="?hal=2"><i class="page"></i></a></li>
					<li><a href="?hal=2">Lihat Band</a></li>
				</ul>
				<ul>
					<li><a href="logout.php"><i class=""></i></a></li>
		...
		<div class="col-md-9 content">
			<div class="home-strip">
				<div class="member">
					...
					<a href='?username=$_SESSION[username]&hal=7'>";
						...
						$name=mysql_query("SELECT * FROM anggota WHERE username_anggota = '$_SESSION[username]'");
						$data = mysql_fetch_array($name); 
						
						$tgl_lahir = $data['tanggal_lahir'];
						$tgl_sekarang = date("Y-m-d");
						$sql ="SELECT datediff ('$tgl_sekarang' , '$tgl_lahir') as selisih";
						$usia = mysql_query($sql);
						$baca=mysql_fetch_array($usia); 
					
					echo "$data[nama]<br>
					".floor($baca['selisih']/365) . " tahun";
					?>
					</a>
					</p>
			...
			<div class="list_of_members">
				...
				<div class="users">
					<h4>TOTAL <strong>Band</strong></h4>
					<?php
					$jumlah=mysql_query("SELECT * FROM band");
					$row=mysql_num_rows($jumlah);
					echo"
					<h3>$row</h3>
					";
			...
			if (!empty($_GET['hal'])){
				if ($_GET['hal'] == 1) 
				{
					include "bandlihat.php";
				}
				else if ($_GET['hal'] == 2) 
				{
					include "bandkelola.php";
				}
				else if ($_GET['hal'] == 3) 
				{
					include "bandkelolaview.php";
				}
				else if ($_GET['hal'] == 4) 
				{
