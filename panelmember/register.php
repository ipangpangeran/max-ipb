...
<div class="login">
		...
		<?php
			...
			if (!empty($_GET['pesan'])) {
				if ($_GET['pesan'] == 1) {
					...
					?>
					<script languange="javascript">alert("Username sudah terdaftar, silahkan gunakan username lain.");</script>
					<?php
	...
	<div class="login-bottom">
		<h3>Have an account? &nbsp;<a href="index.php">Login</a>&nbsp Here</h3>
